...
export const framePropertiesChapter = chapter('frame-properties', 'Frame Properties', 'Recognize and repair structural properties of accessibility relations.', ['models-countermodels'], lessons, ['Frame properties concern only the accessibility relation, not the current valuation.', 'Reflexivity, seriality, symmetry, transitivity, and Euclideanness impose different structural conditions.', 'A frame can satisfy some properties while failing others.'], 'Continue to Modal Axioms and Correspondence to connect these properties with modal formulas.')
