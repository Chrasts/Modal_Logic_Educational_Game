...
export function ModalLogicWelcome({ onBegin, onSkip, onBack }: {
  ...
  return <section className="content-screen welcome-screen" aria-labelledby="welcome-title">
    ...
    <div className="welcome-grid">
      ...
      <article><h2>Why modal logic matters</h2><p>It supports philosophy, computer-system and program verification, reasoning about knowledge and information, temporal reasoning, and linguistics. This learning path focuses on finite Kripke semantics for basic modal logic.</p></article>
