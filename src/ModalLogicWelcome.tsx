...
export function ModalLogicWelcome({ onBegin, onSkip, onBack }: {
  ...
  return <section className="content-screen welcome-screen" aria-labelledby="welcome-title">
    ...
    <div className="welcome-grid">
      ...
      <article className="welcome-cycle"><h2>How each task works</h2><ol><li>Read the goal.</li><li>Make the requested change to the model.</li><li>Select <strong>Check task</strong>.</li><li>Continue when the task is complete.</li></ol></article>
    </div>
