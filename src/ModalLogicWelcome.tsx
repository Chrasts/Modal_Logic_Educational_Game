  ...
  return <section className="content-screen welcome-screen" aria-labelledby="welcome-title">
    ...
    <div className="welcome-grid">
      ...
      <section className="modal-operator-intro" aria-label="Modal operators">
        ...
        <article className="modal-operator-card"><svg className="modal-operator-symbol" viewBox="0 0 64 64" aria-hidden="true"><path d="M32 9 55 32 32 55 9 32Z" /></svg><div><h2>Possibility — ◇φ</h2><p>◇φ is true at a world when φ is true at at least one world accessible from it.</p></div></article>
      </section>
      ...
      <article><h2>Why modal logic matters</h2><p>Modal logic is a long-established formal tool for modelling how truth can vary across possible situations, system states, information states, or moments in time. This makes it useful in computer science and program verification, philosophy, reasoning about knowledge and information, temporal reasoning, and linguistics. This learning path focuses on finite Kripke semantics for basic modal logic.</p></article>
