  ...
  return <section className="content-screen welcome-screen" aria-labelledby="welcome-title">
    ...
    <div className="welcome-grid">
      ...
      <section className="modal-operator-intro" aria-label="Modal operators">
        <article className="modal-operator-card"><span className="modal-operator-symbol" aria-hidden="true">□</span><div><h2>Necessity — □φ</h2><p>□φ is true at a world when φ is true at every world accessible from it.</p></div></article>
        <article className="modal-operator-card"><span className="modal-operator-symbol" aria-hidden="true">◇</span><div><h2>Possibility — ◇φ</h2><p>◇φ is true at a world when φ is true at at least one world accessible from it.</p></div></article>
      </section>
