  ...
  return <section className="content-screen welcome-screen" aria-labelledby="welcome-title">
    ...
    <div className="welcome-grid">
      ...
      <section className="modal-operator-intro" aria-label="Modal operators">
        ...
        <article className="modal-operator-card"><svg className="modal-operator-symbol" viewBox="0 0 64 64" aria-hidden="true"><path d="M32 9 55 32 32 55 9 32Z" /></svg><div><h2>Possibility — ◇φ</h2><p>◇φ is true at a world when φ is true at least one world accessible from it.</p></div></article>
      </section>
