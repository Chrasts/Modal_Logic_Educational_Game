...
export function CreateView({ templates, selectedTemplateId, onSelectedTemplateChange, onOpenStudio, onDuplicateTemplate }: CreateViewProps) {
  useAnalyticsView('create')
