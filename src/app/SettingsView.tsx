...
export function SettingsView({ density, showMinimap, showDerivedRelations, reduceMotion, soundEffects, onDensityChange, onShowMinimapChange, onShowDerivedRelationsChange, onReduceMotionChange, onSoundEffectsChange, onManageData, onReset }: SettingsViewProps) {
  return <section className="content-screen settings-screen" aria-labelledby="settings-title">
    ...
    <div className="settings-grid">
      ...
      <article><h2>Privacy</h2><p>Models, formulas, answers, settings, and study history stay in this browser unless you explicitly export or share them. This build uses privacy-focused Umami analytics for page views and coarse feature-use events. Analytics does not intentionally send model contents, formulas, answers, study history, or persistent user identifiers; URL query strings and fragments are excluded, and browser Do Not Track is respected. No analytics tracking cookies are used.</p><button type="button" className="secondary-button" onClick={onManageData}>Manage local data</button></article>
