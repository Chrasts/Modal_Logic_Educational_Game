...
const possibilityLessonDefinitions: readonly LearnLesson[] = [
  ...
  },
  {
    ...
    learningObjective: 'Identify the accessible world that witnesses a possibility formula.',
  ...
  },
  {
    ...
    learningObjective: 'Distinguish truth somewhere in a model from truth in an accessible alternative.',
  ...
  },
  {
    ...
    learningObjective: 'Understand that a witness relation must point from the evaluation world to the witness world.',
  ...
  },
  {
    ...
    learningObjective: 'Construct a model whose accessible witness satisfies a conjunction.',
...
const truthAtAWorldLessons: readonly LearnLesson[] = [
  ...
  },
  {
    ...
    learningObjective: 'Understand local negation.',
  ...
  },
  {
    ...
    learningObjective: 'Understand that both conjuncts must hold at the same evaluation world.',
  ...
  },
  {
    ...
    learningObjective: 'Apply atomic truth, negation, and world-relative evaluation together.',
...
const worldsAndAccessibilityLessons: readonly LearnLesson[] = [
  {
    id: 'learn-worlds-add', chapterId: 'worlds-accessibility', title: 'Add a world', learningObjective: 'Understand the carrier set W as a finite collection of worlds.',
  ...
  {
    id: 'learn-worlds-directed-edge', chapterId: 'worlds-accessibility', title: 'Directed accessibility', learningObjective: 'Understand that accessibility is a directed binary relation.',
  ...
  {
    id: 'learn-worlds-direction', chapterId: 'worlds-accessibility', title: 'Direction matters', learningObjective: 'Distinguish source and target.',
  ...
  {
    id: 'learn-worlds-branching', chapterId: 'worlds-accessibility', title: 'Branching', learningObjective: 'Understand that one world can have multiple accessible successors.',
  ...
  {
    id: 'learn-worlds-reflexive-edge', chapterId: 'worlds-accessibility', title: 'Reflexive relation', learningObjective: 'Recognize a reflexive relation as a world accessing itself.',
